...
import 'package:flutter_taxiapp/main.dart';
...
class RegistrationScreen extends StatelessWidget {
  ...
  static const String idScn = "register";
          ...
          child: Column(
            children: [
                  ...
                  children: [
                    ...
                    RaisedButton(
                      ...
                      onPressed: ()
                      {
                        ...
                        {
                          displayToastMessage("Password must be atleast contain 6 charcters ", context);
                        }
                        else
                        {
              ...
              FlatButton(
                onPressed: ()
                {
                  Navigator.pushNamedAndRemoveUntil(context, LoginScreen.idScn, (route) => false);
                },
                child: Text(
  ...
  void registerNewUser(BuildContext context) async {
    ...
    if(firebaseUser != null) //user created
    {
      ...
      Map userDataMap = {
        ...
        "emil": emailTextEditingController.text.trim(),
